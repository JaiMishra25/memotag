...
export default function Cta() {
  ...
  return (
    <section
      id="waitlist"
      className="py-20 bg-gradient-to-br from-blue-600 to-purple-700 dark:from-blue-800 dark:to-purple-900 relative overflow-hidden"
    >
      ...
      {/* Floating particles */}
      <motion.div
        className="absolute top-1/4 left-1/4 w-4 h-4 rounded-full bg-white opacity-20"
        animate={{
          y: [0, -30, 0],
          opacity: [0.2, 0.5, 0.2],
        }}
      ...
      />
      <motion.div
        className="absolute bottom-1/3 right-1/4 w-6 h-6 rounded-full bg-white opacity-20"
        animate={{
          y: [0, -40, 0],
          opacity: [0.2, 0.5, 0.2],
        }}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <motion.div
            ...
            className="inline-flex items-center mb-6 bg-white/10 px-4 py-2 rounded-full"
          >
          ...
          <div className="max-w-md mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <motion.div className="relative flex-grow" whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                  <Input
                    ...
                    className="bg-white/10 border-white/20 text-white placeholder:text-blue-200 pr-10 h-12"
            ...
            <p className="mt-4 text-sm text-blue-200">We respect your privacy and will never share your information.</p>
          </div>
        </motion.div>
      </div>
    </section>
